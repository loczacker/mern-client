        ...
        <div className='md:w-1/2 space-y-6'>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
                <div>
                    ...
                    <p className='font-base'>Book Listing</p>
                </div>
                <div>
                    <h3 className='text-3xl font-bold'>550+</h3>
                    <p className='font-base'>Register Users</p>
                </div>
                <div>
                    <h3 className='text-3xl font-bold'>1220+</h3>
                    <p className='font-base'>PDF Downloads</p>
                </div>
            </div>
